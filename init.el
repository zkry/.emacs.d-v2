...
(defun zr/git-link-homepage ()
  (interactive)
  (let ((default-directory (or project-current-directory-override default-directory)))
    (call-interactively #'git-link-homepage)))

(use-package git-link
  :bind (:map
         project-prefix-map
         ("n h" . zr/git-link-homepage)
         ("n l" . git-link)
         ("n c" . git-link-commit))
  :config
...
(add-to-list 'project-switch-commands '(zr/git-link-homepage "Homepage(zr)"))
(use-package forge
  :after magit)
...
'(calendar-holidays
 ...
 '(connection-local-criteria-alist
   '(((:application tramp :machine "localhost")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp :machine "Zachary-Romeros-MacBook-Pro.local")
      tramp-connection-local-darwin-ps-profile)
     ((:application tramp)
      tramp-connection-local-default-system-profile tramp-connection-local-default-shell-profile)
     ((:application eshell)
